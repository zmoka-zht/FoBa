...
def main():
    ...
    parser.add_argument('--test_dataset_path', type=str,
                        default=r'/mnt/dataset/zhanghaotian/CDdataset/SECOND/test')
    ...
    parser.add_argument('--model_type', type=str, default='FoBaMambaBased')
    ...
    parser.add_argument('--resume', type=str, default=r"/mnt/user/zhang_haotian/FoBa/second_transformer.pth")
