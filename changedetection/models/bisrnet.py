...
from changedetection.BiSRNet_help.utils import initialize_weights
...
class FCN(nn.Module):
    def __init__(self, in_channels=3, pretrained=True):
        ...
        state_dict = torch.load(r'/mnt/dataset/zhanghaotian/PretrainWeight/resnet/resnet34-b627a593.pth')
